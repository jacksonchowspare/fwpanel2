...
if [ -n "$NODE_BIN" ]; then
    for t in frontend_port_redirect_test.js frontend_bbr_ui_test.js frontend_sys_controls_test.js \
             frontend_app_wizard_test.js frontend_backup_apps_test.js frontend_term_fed_path_test.js frontend_api_task_test.js frontend_auth_401_test.js test_frontend_handlers.js; do
